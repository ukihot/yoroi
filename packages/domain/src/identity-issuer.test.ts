...
Deno.test("checkOidcClaims: 呼び出し元appが違えばWRONG_APP (dev-revisionトークンの悪用防止)", () => {
...
Deno.test("checkOidcClaims: contextがproductionでなければWRONG_CONTEXT (SEC-034: dev/branch tokenの拒否)", () => {
